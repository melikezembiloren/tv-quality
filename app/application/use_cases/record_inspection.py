...
class RecordInspectionUseCase:
    ...
    Kimin kontrol ettiği bilgisi tutulmuyor (PIN/operatör kaydı yok, bilinçli tercih).
    """
    ...
    def execute(self, input_data: RecordInspectionInput) -> RecordInspectionOutput:
        ...
        inspection = Inspection(
            ...
            defect_category_id=input_data.defect_category_id,
        ...
        return RecordInspectionOutput(
            ...
            defect_category_id=saved_inspection.defect_category_id,
